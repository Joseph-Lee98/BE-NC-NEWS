...
describe("PATCH /api/articles/:article_id", () => {
  test("Responds with 200 code, and updated article object in the response body, when logged in user patches their article with an increase of 1 vote", async () => {
    const loginObj = {
  ...
  test("Responds with 200 code, and updated article object in the response body, when logged in user patches their article with a decrease of 1 vote", async () => {
    const loginObj = {
      username: "butter_bridge",
      password: "P@ssw0rd_Br1dge!",
    };
  ...
  test("Responds with 200 code, and updated article object in the response body, when logged in user patches another user's article with an increase of 1 vote", async () => {
    const loginObj = {
  ...
  test("Responds with 200 code, and updated article object in the response body, when logged in user patches another user's article with a decrease of 1 vote", async () => {
    const loginObj = {
      username: "icellusedkars",
      password: "Ic3ll@usedK@rs2024",
    };
  ...
  test("Responds with 200 code, and updated article object in the response body, when admin patches a user's article with an increase of 1 vote", async () => {
    const loginObj = {
  ...
  test("Responds with 200 code, and updated article object in the response body, when admin patches a user's article with a decrease of 1 vote", async () => {
    const loginObj = {
      username: process.env.ADMIN_USERNAME,
      password: process.env.ADMIN_PASSWORD,
    };
